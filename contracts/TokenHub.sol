...
contract TokenHub is ITokenHub, System, IParamSubscriber{
  ...
  function approveBind(address contractAddr, string memory bep2Symbol) public onlyInit returns (bool) {
    bytes32 bep2TokenSymbol = bep2TokenSymbolConvert(bep2Symbol);
  ...
  function rejectBind(address contractAddr, string memory bep2Symbol) public onlyInit returns (bool) {
    bytes32 bep2TokenSymbol = bep2TokenSymbolConvert(bep2Symbol);
    BindPackage memory bindPackage = bindPackageRecord[bep2TokenSymbol];
    require(bindPackage.bep2TokenSymbol!=bytes32(0x00), "bind request doesn't exist");
    require(contractAddr==bindPackage.contractAddr, "contact address doesn't equal to the contract address in bind request");
  ...
  function expireBind(string memory bep2Symbol) public onlyInit returns (bool) {
    bytes32 bep2TokenSymbol = bep2TokenSymbolConvert(bep2Symbol);
    BindPackage memory bindPackage = bindPackageRecord[bep2TokenSymbol];
    require(bindPackage.bep2TokenSymbol!=bytes32(0x00), "bind request doesn't exist");
  ...
  function transferOut(address contractAddr, address recipient, uint256 amount, uint256 expireTime, uint256 relayFee) override external onlyInit payable returns (bool) {
  ...
  function batchTransferOut(address[] calldata recipientAddrs, uint256[] calldata amounts, address[] calldata refundAddrs, address contractAddr, uint256 expireTime, uint256 relayFee) override external onlyInit payable returns (bool) {
