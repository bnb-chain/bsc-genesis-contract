...
contract("SlashIndicator", (accounts) => {
  ...
  it("slash from no system account", async () => {
    ...
    try {
      ...
      assert.ok(
        error.toString().includes("the message sender must be the block producer"),
        "slash from no system account should not be ok"
      );
    }
  });
});
...
contract("SlashIndicator", (accounts) => {
  it("trigger misdemeanor", async () => {
    ...
    let packageBytes = validatorUpdateRlpEncode(
      [validator, secondValidator, thirdValidator],
      [validator, secondValidator, thirdValidator],
      [validator, secondValidator, thirdValidator]
    );
...
contract("felony SlashIndicator", (accounts) => {
  it("trigger felony ", async () => {
    ...
    packageBytes = validatorUpdateRlpEncode(
      [validator, secondValidator, thirdValidator],
      [validator, secondValidator, thirdValidator],
      [validator, secondValidator, thirdValidator]
    );
...
contract("Clean SlashIndicator", (accounts) => {
  it("test slash clean", async () => {
    ...
    // Do init
    let packageBytes = validatorUpdateRlpEncode(validators, validators, validators);
