...
export const setSlashIndicator = async (slashAddress: string, validatorSet: BSCValidatorSet, instances: any[]) => {
...
export function validatorUpdateRlpEncode(consensusAddrList: any, feeAddrList: any, bscFeeAddrList: any) {
  let pkg = [];
  pkg.push(0x00);
